...
#     W_prime, t_prime, CP, AC, Pmax, m_rider = get_rider_info(rider, df, number_to_name)
#     rider_data[rider] = {
#         "W_prime": W_prime,
#         # "t_prime": t_prime,
#         "CP": CP,
...
# # %%
# # this will give a rough ballpark estimate, but won't be perfect
# def runtime_calculator(num_peels, num_orders, num_changes, num_accel_phases = 1, num_children = 6, num_seeds = 2, num_rounds = 3):
#     length_of_black_box = 0.2 # in seconds 
#     number_of_its = ((num_rounds * num_seeds* (num_children +1)) + num_children + 1)* num_peels * num_orders * num_changes * num_accel_phases
#     correct_its = (num_children + num_seeds * num_children * num_rounds) * num_peels * num_orders * num_changes * num_accel_phases

#     return length_of_black_box * correct_its, correct_its
#     #return length_of_black_box * number_of_its

# # %%
# #checking with what we just did
# est_time, est_itterations = runtime_calculator(num_peels=10, num_orders=24, num_changes=6, num_accel_phases = 1, num_children = 6, num_seeds = 4, num_rounds = 5)
# print(est_time, est_itterations)
